      ...
      <div class='bg-gray-900'>
        <div class='pt-12 px-4 sm:px-6 lg:px-8 lg:pt-20'>
          <div class='text-center'>
            ...
            <p class='mt- text-3xl leading-9 font-semibold text-white-0 sm:text-4xl sm:leading-10 lg:text-5xl lg:leading-none'>
              ...
              <div class='relative lg:grid lg:grid-cols-7'>
                <div class='mx-auto max-w-md lg:mx-0 lg:max-w-none lg:col-start-1 lg:col-end-3 lg:row-start-2 lg:row-end-3'>
                  <div class='h-full flex flex-col rounded-lg shadow-lg overflow-hidden lg:rounded-none lg:rounded-l-lg'>
                    <div class='flex-1 flex flex-col'>
                      <div class='bg-white-0 px-6 py-10'>
                        <div>
                          ...
                          <div class='mt-4 flex items-center justify-center'>
                            ...
                            <span class='text-xl leading-7 font-medium text-gray-600'>
                              /month
                            </span>
                          </div>
                        </div>
                ...
                <div class='mt-10 max-w-lg mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-start-3 lg:col-end-6 lg:row-start-1 lg:row-end-4'>
                  <div class='relative z-10 rounded-lg shadow-xl'>
                    ...
                    <div class='bg-white-0 rounded-t-lg px-6 pt-12 pb-10'>
                      <div>
                        ...
                        <div class='mt-4 flex items-center justify-center'>
                          ...
                          <span class='text-2xl leading-8 font-medium text-gray-600'>
                            /month
                          </span>
                        </div>
                      </div>
      ...
      <div class='bg-indigo-800'>
        <div class='max-w-screen-xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8 lg:py-20'>
          <div class='max-w-4xl mx-auto text-center'>
            <h2 class='text-3xl leading-9 font-semibold text-white-0 sm:text-4xl sm:leading-10'>
          ...
          <dl class='mt-10 text-center sm:max-w-3xl sm:mx-auto sm:grid sm:grid-cols-3 sm:gap-8'>
            <div class='flex flex-col'>
              ...
              <dd class='order-1 text-5xl leading-none font-semibold text-white-0'>
                100%
              </dd>
            </div>
