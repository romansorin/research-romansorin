    ...
    <section>
      <div className='hidden lg:block'>
        <div class='relative bg-gray-50 overflow-hidden'>
          ...
          <div class='relative pt-0 pb-12 sm:pb-16 md:pb-20 lg:pb-28 xl:pb-32'>
        ...
        <div class='py-12 bg-white'>
          <div class='max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div class='lg:text-center'>
              ...
              <h3 class='mt-2 text-3xl leading-8 font-semibold tracking-tight text-gray-900 sm:text-4xl sm:leading-10'>
                ...
                <li>
                  <div class='flex'>
                    <div class='flex-shrink-0'>
                      <div class='flex items-center justify-center h-12 w-12 rounded-md bg-indigo-500 text-white-0'>
                        <svg
                          class='h-6 w-6'
                          stroke='currentColor'
                          fill='none'
        ...
        <div class='container mx-auto relative bg-gray-50 pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8'>
          ...
          <div class='relative max-w-7xl mx-auto'>
            <div class='text-center'>
              <h2 class='text-3xl leading-9 tracking-tight font-semibold text-gray-900 sm:text-4xl sm:leading-10'>
                From the blog
              </h2>
            ...
            <div class='mt-12 grid gap-5 max-w-lg mx-auto lg:grid-cols-3 lg:max-w-none'>
              <div class='flex flex-col rounded-lg shadow-lg overflow-hidden'>
                ...
                <div class='flex-1 bg-white-0 p-6 flex flex-col justify-between'>
                  <div class='flex-1'>
        ...
        <div class='relative bg-gray-800'>
          ...
          <div class='relative max-w-screen-xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16'>
            <div class='md:ml-auto md:w-1/2 md:pl-10'>
              ...
              <h2 class='mt-2 text-white-0 text-3xl leading-9 font-semibold tracking-tight sm:text-4xl sm:leading-10'>
                We’re here to help
              </h2>
              ...
              <div class='mt-8'>
                <div class='inline-flex rounded-md shadow'>
                  <a
                    href='#'
                    class='inline-flex items-center justify-center px-5 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-gray-900 bg-white-0 hover:text-gray-600 focus:outline-none focus:shadow-outline transition duration-150 ease-in-out'
                  >
                    Visit the help center
                    <svg
                      class='-mr-1 ml-3 h-5 w-5 text-gray-600'
                      fill='currentColor'
                      viewBox='0 0 20 20'
                    >
                      <path
