...
const data = {
  ...
  authors: ['Authors of paper', 'Roman Sorin', 'AFGGFG'],
  downloadUrl: '/',
  referenceUrl: '/',
  citation: 'Citation of given article in IEEE format...',
  summary: `Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc nunc
...
const Reference = () => {
  return (
    <section>
      <Heading className='md:mb-24' title={data.title} authors={data.authors} />
      <div className='flex flex-col md:flex-row'>
        <Aside
          ...
          date='NOV 1, 2019'
        />
        <Main referenceUrl={data.referenceUrl} citation={data.citation}>
          {data.summary}
        </Main>
      </div>
    </section>
